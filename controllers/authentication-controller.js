...
exports.protectedRoute = (req, res, next) => {
    try {
        ...
        else throw new HttpError('Unauthorized', 401);
    } 
    catch(err){
        return next(new HttpError(err.message || 'Unauthorized', err.code || 401));
    }
}
...
exports.postLogin = async(req, res, next) => {
    try {
        ...
        return next(new HttpError(err.message || 'Can\'t login, try again later', 500));
    }
}
...
exports.postLogout = (req, res, next) => {
    try {
        ...
        return next(new HttpError(err.message || 'Can\'t logout, try again later', 500));
    }
}
